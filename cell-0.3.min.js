...
var CELL={};CELL.cell=function(spec,my){var _super={};var my=my||{};my.path=spec.path||'/';my.container=spec.container;my.children=my.children||{};my.json=my.json||{};my.element=null;var build;var refresh;var find;var bind;var that=CELL.emitter({});build=function(){throw new Error('`build` must be implemented : '+my.path);my.element=$('<div></div>');my.children['foo']=foo_c({path:my.path+'/foo',container:my.container});my.element.append(my.children['foo'].build());return my.element;};bind=function(){my.hdlr=my.hdlr||function(){var args=Array.prototype.slice.call(arguments);that['emit'].apply(this,args);};for(var c in my.children){if(my.children.hasOwnProperty(c)){my.children[c].off('*',my.hdlr);my.children[c].on('*',my.hdlr);}}};refresh=function(json){my.json=json;for(var c in my.children){if(my.children.hasOwnProperty(c)&&typeof my.json[c]!=='undefined')
